...
Перед подключением используйте отдельный авторизованный инстанс: `webhookUrl` должен быть пустым, а входящие уведомления включены. У него не должно быть других consumers HTTP-очереди во время demo.
